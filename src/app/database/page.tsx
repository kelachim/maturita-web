...
const App = () => {
  ...
  const [activeTab, setActiveTab] = useState(tab ? tab as Models : tabs[0]);
  const [searchText, setSearchText] = useState<string>(id ? id : "");
      ...
      <div className="!mt-0 w-full text-neutral-100 bg-[#131720] border-b-[#2d3547] border-b-[1px]">
        {tabs.map((tab) => (
          <div
            ...
            className={
              activeTab === tab
                ? 'transition-all hover:bg-[#0d1016] active:bg-[#0d1016] active inline-block border-[1px] border-l-0 p-1 px-6 font-medium border-t-0 border-b-0 border-[#212633] select-none'
                : 'transition-all hover:bg-[#0d1016] active:bg-[#0d1016] inline-block border-[1px] border-l-0 p-1 px-6 font-medium border-t-0 border-b-0 border-[#212633] select-none'
            }
